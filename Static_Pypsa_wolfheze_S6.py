...
#Add a store to the bus
network.add(
    "Store",
    "Space_heating_buffer",
    bus="40C_bus",  # Connect the store to 'Heat_40 bus'
    e_nom=23.2,  # Nominal energy capacity in kWh
    e_initial=10,  # Initial energy stored in kWh
    e_min_pu=0,  # Minimum state of charge as a per unit of e_nom
    e_max_pu=1.0,  # Maximum state of charge as a per unit of e_nom
    e_cyclic=False,  # Whether the storage can be cycled from end to start
    efficiency_store=1,  # Efficiency of storing energy (0 to 1)
    efficiency_dispatch=1,  # Efficiency of dispatching energy (0 to 1)
    p_set = 6
)
